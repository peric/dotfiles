...
```sh
git clone https://github.com/zigomir/dotfiles.git ~/.dotfiles
cd ~/.dotfiles
script/bootstrap
```
...
`reload!` is a shortcut to re-source `.zshrc` file. Among other things, this will reload all `.zsh` files in this repository.
